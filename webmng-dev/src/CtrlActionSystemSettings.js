...
CtrlActionSystemSettings.exec = function() {
    ...
    params = defined(params.GetParametersResponse) ? params.GetParametersResponse : {};
    ...
    this.view.render(this.controller.action, {
        _title: AppMain.t("SETTINGS", "SYS_SETTINGS"),
        _title_time: AppMain.t("TIME", "SYS_SETTINGS"),
        _title_general: AppMain.t("GENERAL", "SYS_SETTINGS"),
        elements: {
            selectTimezone: AppMain.html.formElementSelect("dcmng_sys-time-zone", timezoneObj,
                {
                label: "",
                elementSelected: defined(params.dcmng) ? params.dcmng["sys-time-zone"] : "",
            ...
            syncInterval: AppMain.html.formElementSelect("dcmng_ntp-sync-interval", intervalOpt,
                ...
                elementSelected: defined(params.dcmng) ? params.dcmng["ntp-sync-interval"] : "",
        ...
        paramsDcmng: defined(params.dcmng) ? params.dcmng : {},
        paramsIloc: defined(params.iloc) ? params.iloc : {},
        cntr: defined(params.cntr) ? params.cntr : {},
        params:{
        ...
        labels: {
            ...
            title_set: AppMain.t("TITLE_SET", "SYS_SETTINGS"),
...
CtrlActionSystemSettings.__syncTime = function() {
