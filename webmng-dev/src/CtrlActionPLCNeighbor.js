...
CtrlActionPLCNeighbor.exec = function() {
    ...
    const list = this._buildNeighborListHTML(this, neighbors);
 ...
 */
CtrlActionPLCNeighbor._buildNeighborListHTML = function(_this, neighbor) {
    let list = {totalNodes: 0, htmlNeighbors:""};

    neighbor = (neighbor.PlcNeighborTableGetResponse["neighbour-table"] instanceof Array) ? neighbor.PlcNeighborTableGetResponse["neighbour-table"] : neighbor.PlcNeighborTableGetResponse;
    if (typeof neighbor["__prefix"] !== "undefined")
